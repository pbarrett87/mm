...
void FX::create_and_add_transient_lpf(sample frequency){ // ******
	add_transformation(new TransientLPF(frequency));	// ******
}

void FX::create_and_add_transient_hpf(sample frequency){ // ******
	add_transformation(new TransientHPF(frequency));	// ******
}
