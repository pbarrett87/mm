...
void TransientLPF::transientLPF(sample new_transient_lpf_freq) { // ******************
	
	_frequency = new_transient_lpf_freq;
	_sampling_rate = 44100;
    _delay = NULL;
    reset();
...
void TransientHPF::transientHPF(sample new_transient_hpf_freq) { // ******************
	
	_frequency = new_transient_hpf_freq;
	_sampling_rate = 44100;
    _delay = NULL;
    reset();
}
